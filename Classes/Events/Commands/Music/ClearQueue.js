...
var ClearQueue = /** @class */ (function (_super) {
    ...
    function ClearQueue() {
        ...
        _this.commandName = "clear-queue";
        return _this;
    }
    ClearQueue.prototype.execute = function (interaction, args) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        queue.songs = [];
                        return [4 /*yield*/, interaction.reply("🕳️ | Queue was cleared")];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ClearQueue.prototype.createCommand = function () {
