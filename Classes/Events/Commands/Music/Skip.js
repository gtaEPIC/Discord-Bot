...
var Skip = /** @class */ (function (_super) {
    ...
    function Skip() {
        ...
        _this.commandName = "skip";
        return _this;
    }
    Skip.prototype.execute = function (interaction, args) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        queue.skip();
                        return [4 /*yield*/, interaction.followUp("⏭ | Track Skipped")];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Skip.prototype.createCommand = function () {
